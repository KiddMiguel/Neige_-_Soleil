<section class="h-100 sectionConnexion">
    <div class="container py-5 h-100 ">
        <div class="row d-flex justify-content-center align-items-center h-100 ">
            <div class="col ">
                <div class="card card-registration my-4 shadow">
                    <div class="row g-0">
                        <div class="col-xl-6 d-none d-xl-block " style="background-color: #FFF0CB;">
                            <form action="" method="post">
                                <div class="card-body p-md-5 text-black">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 mb-2">
                                            <div class="form-outline">
                                                <input type="text" id="form3Example1m" class="form-control form-control-lg" name="email_locataire" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 mb-2">
                                            <div class="form-outline">
                                                <input type="password" id="form3Example1m" class="form-control form-control-lg" name="mdp_locataire" />
                                                <label class="form-label" for="form3Example1m">Mot de passe</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-start pt-3">
                                        <button type="submit" class="btn btn-warning btn-lg ms-2" name="se_connecter">Connexion</button>
                                        <a class="text-muted ms-5" href="#!"> Mot de passe oublié?</a>

                                    </div>
                                  
                                    <img src="Images/Logo-noir.png" alt="" class="mt-5" width="40%">
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="card-body p-md-5 text-black">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="d-flex justify-content-end ">
                                        <button type="submit" class="btn btn-warning btn-lg ms-2" name="valider">Créer votre compte</button>
                                    </div>
                                </form>
                            </div>
                        </div>
