    <section class="sectionOne position-relative">
        <div class="overlay position-absolute top-0 w-100">
            <div class="mt-custom container-fluid ms-sm-1 ms-md-5 ms-lg-5 ps-5 text-light">
    ...
    <section class="sectionThree container pb-5">
        ...
        <div class=" row">
            <div class="feature col-lg-3 col-md-3 col-sm-6 col-xm-12">
                ...
                <p>présente de nombreux avantages pour la gestion efficace de la location de nos appartements. En fournissant des informations précises sur les équipements, les modalités de paiement et les conditions générales de location.</p>
            </div>
            <div class="feature col-lg-3 col-md-3 col-sm-6 col-xm-12">
                <div class=" text-center mb-3">
                ...
                <p>Il vous permet de stocker et d'organiser les informations essentielles liées à la location de votre bien immobilier en un seul endroit sécurisé, les états des lieux, les quittances de loyer, les dépôts de garantie, etc.</p>
            </div>
        ...
        <div class="help pt-5 mt-5 mb-5 container d-flex justify-content-center align-self-center ">
            <div class="m-auto ">
                ...
                <div class="sendHelp bg-white">
                    ...
                    </select><input class="mt-lg-2 mt-md-2 mt-sm-5 mt-xm-5 mb-2 ps-2" type="text" name="" id=""><button class="bouton ms-2">Envoyer</button>
                </div>
