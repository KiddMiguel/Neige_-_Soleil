                        ...
                        <form class="px-md-2" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="form-outline">
                                        <input type="text" id="form3Example1n" class="form-control form-control" name="adresse_proprio" placeholder="Adresse"/>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input type="text" class="form-control form-control" name="cp_proprio" placeholder="Code postal"/>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <div class="form-outline">
                                        <input type="text" id="form3Example1n" class="form-control form-control" name="ville_proprio" placeholder="Ville" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                                <div class="col-md-6">
                                    <div class="form-outline mt-5">
                                        <button type="submit" name="valider_proprio" class="btn btn-warning btn-lg mb-1">Envoyer</button>
                                    </div>
                                </div>
                            </div>
                        </form>
