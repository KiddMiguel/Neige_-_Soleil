-- Active: 1677139387996@@127.0.0.1@3306@neige_soleil
...
INSERT INTO proprietaire ( civilite_proprio, nom_proprio, prenom_proprio, statut_proprio, email_proprio, mdp_proprio, tel_proprio, adresse_proprio, cp_proprio, ville_proprio, pays_proprio, code_adherent)
VALUES ( 'Mr', 'Durand', 'Jean', 'Particulier', 'jean.durand@email.com', 'motdepasse123', '01 23 45 67 89', '1 rue du Pont', '75001', 'Paris', 'France', '0123456789'),
       ( 'Mme', 'Lefebvre', 'Marie', 'Professionnel', 'marie.lefebvre@email.com', 'password456', '01 34 56 78 90', '2 rue de la Gare', '69001', 'Lyon', 'France', '0123456789'),
       ( 'Mr', 'Garcia', 'Luis', 'Particulier', 'luis.garcia@email.com', 'azerty123', '01 23 45 67 89', '3 rue de la Paix', '13001', 'Marseille', 'France', '0123456789'),
       ( 'Mme', 'Chang', 'Li', 'Professionnel', 'li.chang@email.com', 'secret789', '01 34 56 78 90', '4 avenue des Fleurs', '69002', 'Lyon', 'France', '0123456789');

INSERT INTO contrat (statut_contrat, date_debut_contrat, date_fin_contrat, date_sign_contrat, id_user, id_appart)
VALUES ('En cours', '2022-03-01', '2022-08-31', '2022-03-01', null, 1),
       ('Résilié', '2022-04-01', '2022-08-31', '2022-04-01', null, 2),
       ('En cours', '2022-02-01', '2022-07-31', '2022-02-01', null, 3),
       ('En cours', '2022-01-01', '2022-06-30', '2022-01-01', null, 4),
       ('Résilié', '2022-05-01', '2022-08-31', '2022-05-01', null, 5);



INSERT INTO materiel_proprio (intitule_materiel_proprio, nb_materiel_proprio, prix_materiel_proprio, type_materiel_proprio, staut_materiel_proprio) 
VALUES 
    ('Télévision', 1, '100', 'Electronique', 'Disponible'),
    ('Four', 1, '200', 'Electroménager', 'Disponible'),
    ('Machine à laver', 1, '250', 'Electroménager', 'Disponible'),
    ('Cafetière', 1, '30', 'Electroménager', 'Disponible'),
    ('Fer à repasser', 1, '20', 'Electroménager', 'Disponible'),
    ('Sèche-cheveux', 1, '15', 'Electroménager', 'Disponible'),
    ('Draps', 2, '30', 'Linge de maison', 'Disponible'),
    ('Serviettes', 4, '20', 'Linge de maison', 'Disponible'),
    ('Tondeuse', 1, '150', 'Jardinage', 'Disponible'),
    ('Bicyclette', 1, '100', 'Sport', 'Disponible');
...
INSERT INTO equipement_appart (intitule_equip_appart, nb_equi_appart, prix_equip_appart, type_equip_appart, statut_equip_appart)
VALUES 
('Lave-linge', 1, 500, 'Electromenager', 'Disponible'),
('Lave-vaisselle', 1, 600, 'Electromenager', 'Disponible'),
('Réfrigérateur', 1, 800, 'Electromenager', 'Disponible'),
('Four', 1, 700, 'Electromenager', 'Disponible'),
('Micro-ondes', 1, 300, 'Electromenager', 'Disponible'),
('Cafetière', 1, 50, 'Electromenager', 'Disponible'),
('Aspirateur', 1, 100, 'Electromenager', 'Disponible'),
('Fer à repasser', 1, 80, 'Electromenager', 'Disponible'),
('Télévision', 1, 900, 'Multimedia', 'Disponible'),
('Ordinateur portable', 1, 1200, 'Multimedia', 'Disponible'),
('Enceinte Bluetooth', 1, 100, 'Multimedia', 'Disponible'),
('Lecteur DVD', 1, 50, 'Multimedia', 'Disponible'),
('Table de ping-pong', 1, 250, 'Sport', 'Disponible'),
('Tapis de course', 1, 600, 'Sport', 'Disponible'),
('Set de golf', 1, 800, 'Sport', 'Disponible');
...
VALUES 
    ...
    ("Beau design", 7),
    ("Bien isolé", 8),
    ("Bonne distribution", 8),
    ("Décoration moderne", null),
    ("Quartier animé", null),
    ("Proximité des transports", null),
    ("Proche de la plage", null);
